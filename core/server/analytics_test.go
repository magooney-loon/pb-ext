...
func TestShouldExcludeFromAnalytics(t *testing.T) {
	testCases := []struct {
		...
		{"/static/docs/readme.md", true, "static MD"},
		{"/static/images/logo.png", true, "static image"},
		{"/static/fonts/icon.woff", true, "static font"},
		{"/static/files/document.pdf", true, "static PDF"},
		{"/static/assets/archive.zip", true, "static ZIP"},
		{"/", false, "root path"},
